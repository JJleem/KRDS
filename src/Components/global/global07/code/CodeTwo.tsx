...
<!-- modal -->
<section id="modal_sample_02" class="modal fade alert in shown sample" aria-hidden="false" role="dialog"
...
<!-- //modal -->
  ...
  return (
    <div
      id="accordionCollapse07_01_02"
      className="accordion-collapse collapse"
      aria-expanded="false"
      aria-labelledby="accordionHeader07_01_02"
    >
      <div className="accordion-body">
        ...
        <div className="g-code-box">
          <div className="code-toolbar">
            <pre
              data-src="code/global_07_01_02.html"
              ...
              <code className="language-html">
                ...
                <span className="token tag">
                  ...
                  <span className="token attr-value">
                    <span className="token punctuation attr-equals">=</span>
                    <span className="token punctuation">"</span>
                    modal fade alert in shown sample
                    <span className="token punctuation">"</span>
                  </span>{" "}
