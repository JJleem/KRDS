...
<div class="chk-group-area">
	<ul class="chk-group-wrap">
		<li class="disabled">
			<div class="form-group chk-area chk-column">
				<div class="form-check">
					<input type="radio" name="save_id" id="chk_01" disabled="">
					<label for="chk_01">
						비활성화
					</label>
				</div>
		...
		<li class="checked">
			<div class="form-group chk-area chk-column">
				<div class="form-check">
					<input type="radio" name="save_id" id="chk_02" checked="">
					<label for="chk_02">
						선택됨
					</label>
				</div>
  ...
  return (
    <div
      id="accordionCollapse06_01_03"
      className="accordion-collapse collapse"
      aria-expanded="false"
      aria-labelledby="accordionHeader06_01_03"
    >
      <div className="accordion-body">
        <div className="g-code-box">
          <div className="code-toolbar">
            <pre
              data-src="code/component_06_01_03.html"
