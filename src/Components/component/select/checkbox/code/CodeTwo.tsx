...
<div class="chk-area">
	<div class="form-check sm">
		...
		<label for="chk_1-1a">사이즈 : sm</label>
	</div>
	<div class="form-check">
		<input type="checkbox" id="chk_1-2a">
		<label for="chk_1-2a">사이즈 : md</label>
	</div>
	<div class="form-check lg">
		<input type="checkbox" id="chk_1-3a">
		<label for="chk_1-3a">사이즈 : lg</label>
	</div>
</div>
    `);
    setCopyState("copied");
  ...
  return (
    <div
      id="accordionCollapse06_02_02"
      className="accordion-collapse collapse"
      aria-expanded="false"
      aria-labelledby="accordionHeader06_02_02"
    >
      <div className="accordion-body">
        <div className="g-code-box">
          <div className="code-toolbar">
            <pre
              data-src="code/component_06_02_02.html"
