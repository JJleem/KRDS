...
<div class="tab-area layer">
	...
	<div class="tab line full">
		<ul role="tablist">
			<li id="tab_login_01" aria-selected="true" aria-controls="panel_login_01" class="active"><button type="button" class="btn-tab">일반 회원 로그인 <i class="sr-only created"> 선택됨</i></button></li>
			<li id="tab_login_02" aria-selected="false" aria-controls="panel_login_02"><button type="button" class="btn-tab">기관 회원 로그인</button></li>
		</ul>
	</div>
	<!-- //tab list -->
	...
	<div class="tab-conts-wrap">
							...
							<div class="fieldset">
								...
								<div class="form-group">
									...
									<div class="form-conts btn-ico-wrap">
										<input type="password" id="login_pw" class="form-control" placeholder="8-12자의 영문자, 숫자, 특수문자 조합">
			...
			<div class="helper-box">
				...
				<div class="helper-desc-wrap">
					<ul class="info-list decimal">
						<li>로그인 <a href="#" class="link-txt">관련 도움말</a>이나 다른 사용자가 <a href="#" class="link-txt">자주 찾는 질문</a>을 확인해보세요.</li>
		...
		<section id="panel_login_02" role="tabpanel" aria-labelledby="tab_login_02" class="tab-conts">
  ...
  return (
    <div
      id="accordionCollapse04_10_01"
      className="accordion-collapse collapse"
      aria-expanded="false"
      aria-labelledby="accordionHeader04_10_01"
    >
      <div className="accordion-body">
        <div className="g-code-box">
          <div className="code-toolbar">
            <pre
              data-src="code/component_04_10_01.html"
            ...
            >
              <code className="language-html">
                ...
                <span className="token comment">&lt;!-- tab list --&gt;</span>
                <span className="token tag">
                  <span className="token tag">
                    <span className="token punctuation">&lt;</span>
                    div
                ...
                <span className="token tag">
                  ...
                  <span className="token attr-name">aria-selected</span>
                  <span className="token attr-value">
                    <span className="token punctuation attr-equals">=</span>
                    <span className="token punctuation">"</span>
                    true
                ...
                <span className="token comment">&lt;!-- 로그인 폼 --&gt;</span>
                <span className="token tag">
                  <span className="token tag">
                    <span className="token punctuation">&lt;</span>
                    div
                ...
                <span className="token tag">
                  ...
                  <span className="token attr-value">
                    <span className="token punctuation attr-equals">=</span>
                    <span className="token punctuation">"</span>
                    btn sm btn-txt ico-func ico-before
                    <span className="token punctuation">"</span>
                  </span>
                  <span className="token punctuation">&gt;</span>
                </span>
                ...
                <span className="token comment">&lt;!-- 도움박스 --&gt;</span>
                <span className="token tag">
                  <span className="token tag">
                    <span className="token punctuation">&lt;</span>
                    div
                ...
                02-3703-2500 (내선번호 4번)으로 전화주세요. 서비스에 로그인할 수
                있도록 도와드리겠습니다.
                <span className="token tag">
                  <span className="token tag">
                    <span className="token punctuation">&lt;/</span>
