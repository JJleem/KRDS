...
<!-- modal -->
<section id="modal_sample_02" class="modal fade alert in shown" aria-hidden="false" role="dialog" aria-labelledby="tit_modal_sample_02">
	<div class="modal-dialog">
		<div class="modal-content" tabindex="0">
			<!-- modal title -->
			<div class="modal-header">
				<h2 id="tit_modal_sample_02" class="modal-title">
					모달 제목 - 얼럿형
				</h2>
			</div>
			<!-- //modal title -->
...
<!-- //modal -->
  ...
  return (
    <div
      id="accordionCollapse04_05_02"
      className="accordion-collapse collapse"
      aria-expanded="false"
      aria-labelledby="accordionHeader04_05_02"
    >
      <div className="accordion-body">
        <div className="g-code-box">
          <div className="code-toolbar">
            <pre
              data-src="code/component_04_05_02.html"
