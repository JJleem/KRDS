...
<div class="file-upload">
    ...
    <button type="button" class="btn primary ico-before ico-upload md">파일선택</button>
</div>
<!-- //파일업로드 -->
<!-- 파일업로드 -->
<div class="file-upload-result">
    <div class="upload-top">
        <div class="file-total"><span class="current">3개</span> / 10개</div>
        <button type="button" class="btn btn-txt ico-before ico-del sm h-auto">전체 파일 삭제</button>
    </div>
    <ul class="upload-list">
        <li>
            <div class="in">
                <div class="file-name">전입신고서 [주민등록법 시행령 : 별지서식 15, 15호의2호] [hwp, 17KB]</div>
                <div class="file-btn">
...
<!-- //파일업로드 리스트 -->
  ...
  return (
    <div
      id="accordionCollapse09_04_01"
      className="accordion-collapse collapse"
      aria-expanded="false"
      aria-labelledby="accordionHeader09_04_01"
    >
      <div className="accordion-body">
        ...
        <div className="g-code-box">
          <div className="code-toolbar">
            <pre
              data-src="code/component_09_04_01.html"
              className="language-html"
              data-src-status="loaded"
              tabIndex={0}
            >
              <code className="language-html">
                <span className="token comment">&lt;!-- 파일업로드 --&gt;</span>
                ...
                <span className="token tag">
                  ...
                  <span className="token attr-value">
                    <span className="token punctuation attr-equals">=</span>
                    <span className="token punctuation">"</span>
                    btn primary ico-before ico-upload md
                    <span className="token punctuation">"</span>
                  </span>
                  <span className="token punctuation">&gt;</span>
                </span>
                ...
                <span className="token tag">
                  ...
                  <span className="token attr-value">
                    <span className="token punctuation attr-equals">=</span>
                    <span className="token punctuation">"</span>
                    btn btn-txt ico-before ico-del sm h-auto
                    <span className="token punctuation">"</span>
                  </span>
                  <span className="token punctuation">&gt;</span>
                </span>
                ...
                전입신고서 [주민등록법 시행령 : 별지서식 15, 15호의2호] [hwp,
                17KB]
                <span className="token tag">
                  <span className="token tag">
                    <span className="token punctuation">&lt;/</span>
                ...
                전입재등록신고서 [주민등록법 시행령 : 별지서식 15, 15호의2호]
                [hwp, 17KB]
                <span className="token tag">
                  <span className="token tag">
                    <span className="token punctuation">&lt;/</span>
